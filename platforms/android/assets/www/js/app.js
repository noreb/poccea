...
console.log('mainControler - ceasimulator : ' + JSON.stringify($scope.ceasimulator));
console.log('mainControler - car : ' + JSON.stringify($scope.car));
